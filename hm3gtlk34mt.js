...
<div class="cv-player-body">
    <div class="cv-player-embed">
        <iframe src="https://65prkkijdn4y7jak.blogspot.com/?vid=`+server_default+`" allowFullScreen></iframe>
    </div>
</div>
...
<div class="cv-player-outside">
    ...
    <div>
      <button data-caption="720p" data-src="`+server_1+`">OPCIÓN 01 <span>`+name_server_1+`</span></button>
      <button data-caption="720p" data-src="`+server_2+`">OPCIÓN 02 <span>`+name_server_2+`</span></button>
      <button data-caption="720p" data-src="`+server_3+`">OPCIÓN 03 <span>`+name_server_3+`</span></button>
      <button data-caption="720p" data-src="`+server_4+`">OPCIÓN 04 <span>`+name_server_4+`</span></button>
      <button data-caption="720p" data-src="`+server_5+`">OPCIÓN 05 <span>`+name_server_5+`</span></button>
      <button data-caption="720p" data-src="`+server_6+`">OPCIÓN 06 <span>`+name_server_6+`</span></button>
    </div>
...
<div class="cv-player-download">
    ...
    <ul>
      <li>
        <a target="_blank" href="`+download_1+`">`+name_download_1+`<span>720p</span></a>
        <a target="_blank" href="`+download_2+`">`+name_download_2+`<span>720p</span></a>
        <a target="_blank" href="`+download_3+`">`+name_download_3+`<span>720p</span></a>
      </li>
    </ul>
</div>
</div>
